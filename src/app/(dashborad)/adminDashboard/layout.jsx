import Navbar from '@/components/adminDashboardComponent/Navbar';
import Sidebar from '@/components/adminDashboardComponent/Sidebar';
import React from 'react';

const AdminDashboradLayout = ({children}) => {
    return (
...
export default AdminDashboradLayout;