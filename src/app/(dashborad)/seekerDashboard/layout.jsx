import Navbar from '@/components/seekerDashboardComponent/Navbar';
import Sidebar from '@/components/seekerDashboardComponent/Sidebar';
import React from 'react';

const SeekerDashboradLayout = ({children}) => {
    return (
...
export default SeekerDashboradLayout;